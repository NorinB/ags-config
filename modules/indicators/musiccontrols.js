...
const colorMode = Utils.exec(
  "bash -c \"sed -n '1p' $HOME/.cache/ags/user/colormode.txt\"",
);
...
function isRealPlayer(player) {
  return (
    ...
    !(
      hasPlasmaIntegration &&
      player.busName.startsWith("org.mpris.MediaPlayer2.brave")
    ) &&
    !(
      hasPlasmaIntegration &&
      ...
      updateCover: (self) => {
        ...
        execAsync([
          ...
          .then(() => {
            ...
            exec(
              `cp ${GLib.get_user_cache_dir()}/wal/colors.scss ${App.configDir}/scss/_musicwal.scss`,
            );
